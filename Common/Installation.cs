// $Id: Installation.cs 1556 2012-12-25 09:37:31Z onuchin $
...
namespace P
{
    ...
    public class Installation : Installer
    {
        ...
        private static string[] unExLogSources = {"P.UnEx"};
        #endregion
        ...
        public override void Install (IDictionary savedState)
        {
            ...
            PEventLog.Install(unExLogName, unExLogSources);
            #endregion
        }
        ...
        public override void Uninstall (IDictionary savedState)
        {
            ...
            PEventLog.Uninstall(unExLogName, unExLogSources);
            #endregion
