// $Id: MemCheck.cs 1556 2012-12-25 09:37:31Z onuchin $
...
namespace P
{
    ...
    public class MemCheck
    {
        ...
        static MemCheck()
        {
            ...
            if (ConfigurationManager.AppSettings[AppConfig.P_MemCheck] != null) {
                check = bool.Parse(ConfigurationManager.AppSettings[AppConfig.P_MemCheck]);
            }
