...
namespace P
{
    ...
    /// See P.Rtp.PerformanceCounters.cs for a good example of how to override these classes to create perf counters.
    /// </FileSummary>
    ...
    public abstract class BasePC
    {
        ...
        public class PerformanceCounterWrapper
        {
           private PerformanceCounter pc;
            private static PEventLog eventLog = new PEventLog("PRtp", ".", "PerformanceCounter");
