            ...
            try {
                ...
                if (e != null) {
                    ...
                    info = string.Format(CultureInfo.CurrentCulture, Strings.NonCLSCompliantException,
                        args.ExceptionObject.GetType(), args.ExceptionObject);
                }

                // List type and string of Sender
                info += "\n\n" + string.Format(CultureInfo.CurrentCulture, Strings.SenderType, sender.GetType());
                info += "\n" + string.Format(CultureInfo.CurrentCulture, Strings.SenderString, sender);
                ...
                try
                {
                    EventLog eventLog = new EventLog("UnhandledEx", ".", "P.UnEx");
                ...
                bool showMsg = true;
                if (ConfigurationManager.AppSettings["ShowErrors"] != null) {
                    showMsg = bool.Parse(ConfigurationManager.AppSettings["ShowErrors"]);
                }
