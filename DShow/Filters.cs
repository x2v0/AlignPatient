// $Id: Filters.cs 1982 2013-10-25 12:51:46Z onuchin $
...
namespace P.DShow
{
    ...
    public abstract class Filter
    {
        ...
        public static readonly Guid CLSID_LegacyAmFilterCategory     = new Guid("083863F1-70DE-11d0-BD40-00A0C911CE86");
        ...
        public static CheckPosFilter CheckPosFilter()
        {
           return new CheckPosFilter(new FilterInfo(null, "CheckPosFilter", CLSID_LegacyAmFilterCategory));
        }
        ...
        public static void ShowDialog(IBaseFilter iBF, IntPtr hwnd)
        {
            ...
            PropertyPage pp = new PropertyPage((ISpecifyPropertyPages)iBF, Name(iBF));
            pp.Show(hwnd);
        }
        ...
        {
            get{return HasDialog(BaseFilter);}
        }
    ...
    public class VideoCompressor : Compressor
    {
        ...
        /// </summary>
        private static Guid DefaultMediaType = MediaType.SubType.WMMEDIASUBTYPE_WMV3;
...
//            catch(COMException){}
    ...
    public class AudioCompressor : Compressor
    {
        ...
        private static void ConfigureCustomFormats() {
            ...
            if ((setting = ConfigurationManager.AppSettings[AppConfig.MDS_AudioCompressionFormat]) != null) {
                ...
                // i.e. - P.DShow.AudioCompressionFormat2
    ...
    public class CheckPosFilter : Filter
    {
       public CheckPosFilter(FilterInfo fi) : base(fi) { }

       protected override IBaseFilter InstantiateFilter()
       {
          return (IBaseFilter)CheckPosFilterClass.CreateInstance();
       }
    }
    ...
    public class PhysicalConnector
    {
        ...
        public override string ToString()
        {
            return string.Format(CultureInfo.CurrentCulture, "Name: {0}, Connection type: {1}, Index: {2}", 
                P.DShow.Pin.Name(Pin), pct.ToString(), index);
        }
    }
}
