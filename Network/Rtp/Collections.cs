...
namespace P.Net.Rtp
{
    ...
    {
        public CNameToParticipantHashtable(int length) {}
        public CNameToParticipantHashtable() {}
    ...
    {
        public SSRCToParticipantHashtable(int length) {}
        public SSRCToParticipantHashtable() {}
        ...
        public override string ToString()
        {
            ...
            {
               builder.Append(String.Format("{0} == > {1}, ", o, Dictionary[o]));
            }
    ...
    {
        public SSRCToStreamHashtable(int length) {}
        public SSRCToStreamHashtable() {}
    ...
    public class IPStreamPairHashtable : DictionaryBase
    {
        ...
        public IPStreamPairHashtable(int length) {}
        public IPStreamPairHashtable() {}
    ...
    {
        public SsrcToSdesDataHashtable(int length) {}
        public SsrcToSdesDataHashtable() {}
