// $Id: EventThrower.cs 1750 2013-02-08 12:09:58Z onuchin $
...
namespace P.Net.Rtp
{
    ...
    internal class EventThrower
    {
       ...
       private static Thread eventThread = new Thread(EventThread);
        ...
        { get { return syncWorkItems.Count; } }
        static public int PeakEventQueueLength
        { get { return peakQueueLength; } }
        #endregion
        #region Constructors
        static EventThrower()
        {
