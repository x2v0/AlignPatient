...
{
    /// <summary>
    /// This class should run on a  client machine and handles the Join and Leave process by 
    ...
    public class RegistrarClient
    {
        ...
        /// </summary>
        IPEndPoint _joiningMulticastEp;
        ...
        public int join(IPAddress groupIP, int groupPort)
        {
            try
            {
                ...
                _joiningMulticastEp = new IPEndPoint(groupIP, groupPort);
            ...
            catch(Exception e)
            {
                eventLog.WriteEntry(string.Format(CultureInfo.CurrentCulture, Strings.JoinRequestToServerFailed, 
                    regSrvIP, regSrvPort, _joiningMulticastEp, e), System.Diagnostics.EventLogEntryType.Error, 
        ...
        public void leave()
        {
            try
            {
                ...
                RegisterMessage regMsg = new RegisterMessage(MessageType.Leave,_joiningMulticastEp.Address, _joiningMulticastEp.Port, refSrvCookie);
