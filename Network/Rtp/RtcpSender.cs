...
namespace P.Net.Rtp
{
    public class RtcpSender : IDisposable
    {
        ...
        private Thread threadRtcpSender;

        /// <summary>
        /// Object that actually sends outgoing multicast Rtcp packets
        /// </summary>
        private INetworkSender rtcpNetworkSender;

        /// <summary>
        /// An optional additional receiver for RTCP messages
        /// </summary>
        private INetworkSender diagnosticSender;
        ...
        private int bytesPerPacketAvg;
        private int bytesPerPacketMax;
        private int bytesPerPacketMin;
        private uint bytes;

        private short packetsPerIntervalMax;
        private uint   packets;

        private short intervalForced;
        private int   intervalMax;
        private int   intervalMin;
        private int   intervals;
        private uint   intervalsSum;
        ...
        private void Initialize()
        {
            ...
            threadRtcpSender = new Thread(SendThread);
