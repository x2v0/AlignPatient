// $Id: RtpListener.cs 1750 2013-02-08 12:09:58Z onuchin $
// Author: Valeriy Onuchin   20.12.2011
...
namespace P.Net.Rtp
{
    ...
    internal class RtpListener: IDisposable
    {
        ...
        public RtpListener(IPEndPoint nextHopEP, IPEndPoint groupEP, RtpSession rtpSession)
        {
            ...
            returnBufferHandler = ReturnBuffer;
            getBufferHandler = GetBuffer;
        ...
        public void Dispose()
        {
            ...
            catch(Exception e)
            {
                LogEvent(string.Format(CultureInfo.CurrentCulture, Strings.ErrorDisposingRtpListener, 
                    e), EventLogEntryType.Error, (int)RtpEL.ID.Error);
            }
        }
        ...
        {
           threadDistributePackets = new Thread(DistributePackets);
            ...
            threadReceivePackets = new Thread(ReceivePackets);
        ...
        private void InitializePerformanceCounters()
        {
            ...
            if (BasePC.PerformanceCounterWrapper.HasUserPermissions())
            {
                lock(pcLock)
                {
                    pc = new RtpListenerPC(rtpSession.Sdes.CName + " - " + nextHopEP);
                }
            }
        }
            ...
            while(true)
            {
                ...
                catch (System.Net.Sockets.SocketException e)
                {
                    ...
                    if (e.ErrorCode != 10060)
                    {
                        ...
                        EventThrower.QueueUserWorkItem( RtpEvents.RaiseHiddenSocketExceptionEvent, args );
