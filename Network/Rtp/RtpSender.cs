...
namespace P.Net.Rtp
{
    ...
    public class RtpSender
    {
        ...
        public void Dispose()
        {
            ...
            {
                LogEvent(string.Format(CultureInfo.CurrentCulture, Strings.ErrorWhileDisposingRtpSender, e),
        ...
        public void Send(IntPtr[] ptrs, int[] lengths, bool prependLengths)
        {
            ...
            frame.UnmanagedData(ptrs, lengths, prependLengths);
        ...
        {
            rtpNetworkSender.DisableLoopback();
        }
        ...
        private void Send()
        {
            ...
            {
                eventLog.WriteEntry(string.Format(CultureInfo.CurrentCulture, Strings.ErrorDuringRtpSenderSend, e),
                                    EventLogEntryType.Error, (int)RtpEL.ID.Error);
            ...
            int pxInFrame = frame.PacketCount;
    ...
    internal abstract class RtpSenderFec : RtpSender
    {
        ...
        private int fecPackets;
        private int fecBytes;
